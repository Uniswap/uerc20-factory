...
contract UERC20FactoryTest is Test {
    ...
    function test_create_succeeds_withMint() public {
        UERC20 token =
            UERC20(factory.createToken(name, symbol, decimals, 1e18, recipient, abi.encode(tokenMetadata), bytes("")));
    ...
    function test_create_revertsWithNotCreator() public {
        ...
        factory.createToken(name, symbol, decimals, 1e18, recipient, abi.encode(tokenMetadata), bytes(""));
    }
    ...
    function test_getUERC20Address_succeeds() public {
        ...
        address expectedAddress = factory.getUERC20Address(name, symbol, decimals, tokenMetadata.creator, bytes(""));
    ...
    function test_create_succeeds_withEventEmitted() public {
        address tokenAddress = factory.getUERC20Address(name, symbol, decimals, tokenMetadata.creator, bytes(""));
    ...
    function test_create_succeeds_withDifferentAddresses() public {
        ...
        address expectedNewAddress =
            factory.getUERC20Address(name, differentSymbol, decimals, tokenMetadata.creator, bytes(""));
        UERC20 newToken = UERC20(
            factory.createToken(name, differentSymbol, decimals, 1e18, recipient, abi.encode(tokenMetadata), bytes(""))
        );
    ...
    function test_getUERC20Address_differentMetadata_sameAddress() public view {
        ...
        address originalAddr = factory.getUERC20Address(name, symbol, decimals, tokenMetadata.creator, bytes(""));
        ...
        address newAddr = factory.getUERC20Address(name, symbol, decimals, differentMetadata.creator, bytes(""));
