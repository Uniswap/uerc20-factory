...
contract TokenFactoryTest is Test {
    ...
    function test_create_succeeds_withMint() public {
        ...
        Token token = factory.create(name, symbol, decimals, totalSupply, recipient, homeChainId);
    ...
    function test_create_succeeds_withEventEmitted() public {
        ...
        bytes32 initCodeHash = keccak256(
            abi.encodePacked(
                type(Token).creationCode, abi.encode(name, symbol, decimals, totalSupply, recipient, homeChainId)
            )
        );
        ...
        emit TokenCreated(tokenAddress, block.chainid, name, symbol, decimals, homeChainId);
        factory.create(name, symbol, decimals, totalSupply, recipient, homeChainId);
    }
    ...
    function test_create_succeeds_withDifferentAddresses() public {
        ...
        Token newToken = factory.create(name, symbol, decimals, totalSupply, recipient, homeChainId);
